        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:justify-end p-0 sm:p-4 md:p-6">
          ...
          <Card className="relative w-full sm:max-w-md h-full sm:h-[650px] max-h-screen flex flex-col shadow-2xl border-0 bg-white/95 backdrop-blur-sm sm:rounded-lg rounded-none">
            ...
            <CardContent className="flex-1 flex flex-col p-0 overflow-hidden">
              <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gradient-to-b from-gray-50/70 to-white/90">
              ...
              <div className="p-4 bg-white/95 border-t border-gray-100 sticky bottom-0 z-10">
                <div className="flex space-x-2 mb-2">
                  <input
                    ...
                    className="flex-1 px-3 sm:px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-gray-50 focus:bg-white transition-all min-h-[44px]"
                  />
                  <Button
                ...
                <div className="flex items-center justify-center">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="text-xs sm:text-sm border-primary text-primary hover:bg-primary hover:text-white rounded-full px-4 py-2 bg-transparent min-h-[36px] font-medium shadow"
                  >
